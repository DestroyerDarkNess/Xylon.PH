...
namespace ProcessHacker.Native.Objects
{
    ...
    {
        private static Common.WeakReference<SamServerHandle> _connectServerHandle;
        ...
        public static SamServerHandle ConnectServerHandle
        {
            get
            {
                Common.WeakReference<SamServerHandle> weakRef = _connectServerHandle;
                ...
                if (connectHandle == null)
                {
                    ...
                    if (connectHandle != null)
                        _connectServerHandle = new Common.WeakReference<SamServerHandle>(connectHandle);
                }
