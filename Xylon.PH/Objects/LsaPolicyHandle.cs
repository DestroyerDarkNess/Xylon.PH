...
namespace ProcessHacker.Native.Objects
{
    ...
    {
        private static Common.WeakReference<LsaPolicyHandle> _lookupPolicyHandle;
        ...
        public static LsaPolicyHandle LookupPolicyHandle
        {
            get
            {
                Common.WeakReference<LsaPolicyHandle> weakRef = _lookupPolicyHandle;
                ...
                if (policyHandle == null)
                {
                    ...
                    if (policyHandle != null)
                        _lookupPolicyHandle = new Common.WeakReference<LsaPolicyHandle>(policyHandle);
                }
